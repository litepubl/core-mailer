...
class Mailer implementsMailerInterface
{
...
public function __construct()
{
    ...
    protected function send(string $from, string $to, string $subj, string $body)
    {
    ...
    public function sendmail($fromname, $fromemail, $toname, $toemail, $subj, $body)
    {
        ...
        return $this->send(static ::CreateEmail($fromname, $fromemail), static ::CreateEmail($toname, $toemail), $subj, $body);
    }
